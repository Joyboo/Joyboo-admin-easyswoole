...
use EasySwoole\DoctrineAnnotation\AnnotationException;
...
use EasySwoole\DoctrineAnnotation\Tests\Fixtures\AnnotationWithConstants;
use EasySwoole\DoctrineAnnotation\Tests\Fixtures\ClassWithConstants;
use EasySwoole\DoctrineAnnotation\Tests\Fixtures\InterfaceWithConstants;
 ...
 * @EasySwoole\DoctrineAnnotation\Tests\Name(foo="bar")
 * @ignore
 */
DOCBLOCK;
...
DOCBLOCK;
    ...
    {
        $parser = new DocParser();
        $parser->setImports(['__NAMESPACE__' => 'EasySwoole\DoctrineAnnotation\Tests\Fixtures']);
        ...
        //({attribute name}, {attribute value})
         return [
            // mixed type
             ...
             ['mixed', '1'],
             ['mixed', '1.2'],
             ['mixed', '@EasySwoole\DoctrineAnnotation\Tests\Fixtures\AnnotationTargetAll'],
            ...
            // string type
             ...
             ['arrayOfAnnotations', '{@EasySwoole\DoctrineAnnotation\Tests\Fixtures\AnnotationTargetAll}'],
             [
                 'arrayOfAnnotations',
                 '{
                     @AnnotationExtendsAnnotationTargetAll,
                     @EasySwoole\DoctrineAnnotation\Tests\Fixtures\AnnotationTargetAll
                 }',
             ],

            // annotation instance
             ['annotation', '@EasySwoole\DoctrineAnnotation\Tests\Fixtures\AnnotationTargetAll'],
    ...
    public function getAnnotationVarTypeProviderInvalid(): array
    {
         ...
         return [
            // boolean type
             ...
             ['boolean','boolean','@Name', 'an instance of EasySwoole\DoctrineAnnotation\Tests\Name'],
            ...
            // string type
             ...
             [
                 ...
                 '@Name',
                 'an instance of EasySwoole\DoctrineAnnotation\Tests\Name',
             ],
         ];
    }
    ...
    public function getAnnotationVarTypeArrayProviderInvalid()
    {
         ...
         return [
             ...
             [
                 'arrayOfAnnotations',
                 AnnotationTargetAll::class,
                 '{@EasySwoole\DoctrineAnnotation\Tests\Fixtures\AnnotationTargetAll,true}',
                 'boolean',
             ],
             [
                 'arrayOfAnnotations',
             ...
             [
                 'arrayOfAnnotations',
                 AnnotationTargetAll::class,
                 '{@EasySwoole\DoctrineAnnotation\Tests\Fixtures\AnnotationTargetAll,1.2}',
                 'double',
             ],
             [
                 'arrayOfAnnotations',
    ...
    public function testAnnotationWithVarType(string $attribute, string $value): void
    {
        ...
        $docblock = sprintf(
            '@EasySwoole\DoctrineAnnotation\Tests\Fixtures\AnnotationWithVarType(%s = %s)',
            $attribute,
            $value
        );
        $parser->setTarget(Target::TARGET_PROPERTY);
    ...
    public function testAnnotationWithVarTypeError(
        ...
        try {
            ...
            self::assertStringMatchesFormat(
                ...
                '" of @EasySwoole\DoctrineAnnotation\Tests\Fixtures\AnnotationWithVarType' .
    ...
    public function testAnnotationWithAttributes(string $attribute, string $value): void
    {
        ...
        $context  = 'property SomeClassName::$invalidProperty.';
        $docblock = sprintf(
            '@EasySwoole\DoctrineAnnotation\Tests\Fixtures\AnnotationWithAttributes(%s = %s)',
            $attribute,
            $value
        );
        $parser->setTarget(Target::TARGET_PROPERTY);
    ...
    public function testAnnotationWithAttributesError(
        ...
        try {
            ...
            self::assertStringContainsString(sprintf(
                '[Type Error] Attribute "%s" of @EasySwoole\DoctrineAnnotation\Tests\Fixtures\AnnotationWithAttributes' .
    ...
    */
    public function testAnnotationWithAttributesWithVarTypeArrayError(
        ...
        try {
            ...
            self::assertStringContainsString(sprintf(
                ...
                ' @EasySwoole\DoctrineAnnotation\Tests\Fixtures\AnnotationWithAttributes declared' .
    ...
    public function testAnnotationWithRequiredAttributes(): void
    {
        ...
        $docblock = '@EasySwoole\DoctrineAnnotation\Tests\Fixtures\AnnotationWithRequiredAttributes' .
            '("Some Value", annot = @EasySwoole\DoctrineAnnotation\Tests\Fixtures\AnnotationTargetAnnotation)';
        $result   = $parser->parse($docblock);
        ...
        $docblock = '@EasySwoole\DoctrineAnnotation\Tests\Fixtures\AnnotationWithRequiredAttributes("Some Value")';
        try {
            $parser->parse($docblock, $context);
            $this->fail();
        } catch (AnnotationException $exc) {
            self::assertStringContainsString(
                'Attribute "annot" of @EasySwoole\DoctrineAnnotation\Tests\Fixtures\AnnotationWithRequiredAttributes' .
                ' declared on property SomeClassName::invalidProperty. expects a(n)' .
                ' EasySwoole\DoctrineAnnotation\Tests\Fixtures\AnnotationTargetAnnotation.' .
        ...
        $docblock = '@EasySwoole\DoctrineAnnotation\Tests\Fixtures\AnnotationWithRequiredAttributes' .
            '(annot = @EasySwoole\DoctrineAnnotation\Tests\Fixtures\AnnotationTargetAnnotation)';
        try {
            $parser->parse($docblock, $context);
            $this->fail();
        } catch (AnnotationException $exc) {
            self::assertStringContainsString(
                'Attribute "value" of @EasySwoole\DoctrineAnnotation\Tests\Fixtures\AnnotationWithRequiredAttributes' .
    ...
    public function testAnnotationWithRequiredAttributesWithoutConstructor(): void
    {
        ...
        $docblock = '@EasySwoole\DoctrineAnnotation\Tests\Fixtures\AnnotationWithRequiredAttributesWithoutConstructor' .
            '("Some Value", annot = @EasySwoole\DoctrineAnnotation\Tests\Fixtures\AnnotationTargetAnnotation)';
        $result   = $parser->parse($docblock);
        ...
        $docblock = <<<'ANNOTATION'
@EasySwoole\DoctrineAnnotation\Tests\Fixtures\AnnotationWithRequiredAttributesWithoutConstructor("Some Value")
ANNOTATION;
        try {
            $parser->parse($docblock, $context);
            $this->fail();
            ...
            self::assertStringContainsString(
                'Attribute "annot" of' .
                ' @EasySwoole\DoctrineAnnotation\Tests\Fixtures\AnnotationWithRequiredAttributesWithoutConstructor' .
                ' declared on property SomeClassName::invalidProperty. expects a(n)' .
                ' \EasySwoole\DoctrineAnnotation\Tests\Fixtures\AnnotationTargetAnnotation.' .
                ' This value should not be null.',
                $exc->getMessage()
    ...
    public function testAnnotationEnumeratorException(): void
    {
        $parser   = $this->createTestParser();
        $context  = 'property SomeClassName::invalidProperty.';
        $docblock = '@EasySwoole\DoctrineAnnotation\Tests\Fixtures\AnnotationEnum("FOUR")';

        $parser->setIgnoreNotImportedAnnotations(false);
        $parser->setTarget(Target::TARGET_PROPERTY);
        $this->expectException(AnnotationException::class);
        $this->expectExceptionMessage(
            'Attribute "value" of @EasySwoole\DoctrineAnnotation\Tests\Fixtures\AnnotationEnum declared' .
    ...
    public function testAnnotationEnumeratorLiteralException(): void
    {
        $parser   = $this->createTestParser();
        $context  = 'property SomeClassName::invalidProperty.';
        $docblock = '@EasySwoole\DoctrineAnnotation\Tests\Fixtures\AnnotationEnumLiteral(4)';

        $parser->setIgnoreNotImportedAnnotations(false);
        $parser->setTarget(Target::TARGET_PROPERTY);
        $this->expectException(AnnotationException::class);
        $this->expectExceptionMessage(
            'Attribute "value" of @EasySwoole\DoctrineAnnotation\Tests\Fixtures\AnnotationEnumLiteral declared' .
    ...
    {
        $parser   = $this->createTestParser();
        $docblock = '@EasySwoole\DoctrineAnnotation\Tests\Fixtures\AnnotationEnumInvalid("foo")';
    ...
    {
        $parser   = $this->createTestParser();
        $docblock = '@EasySwoole\DoctrineAnnotation\Tests\Fixtures\AnnotationEnumLiteralInvalid("foo")';
    ...
    public function getConstantsProvider(): array
    {
        ...
        $provider[] = [
            '@EasySwoole\DoctrineAnnotation\Tests\Fixtures\AnnotationWithConstants(AnnotationWithConstants::STRING)',
            AnnotationWithConstants::STRING,
        ];
        $provider[] = [
            '@AnnotationWithConstants(EasySwoole\DoctrineAnnotation\Tests\Fixtures\AnnotationWithConstants::FLOAT)',
        ...
        $provider[] = [
            '@AnnotationWithConstants(EasySwoole\DoctrineAnnotation\Tests\Fixtures\ClassWithConstants::SOME_VALUE)',
            ClassWithConstants::SOME_VALUE,
        ];
        $provider[] = [
        ...
        $provider[] = [
            '@AnnotationWithConstants(\EasySwoole\DoctrineAnnotation\Tests\Fixtures\InterfaceWithConstants::SOME_VALUE)',
            InterfaceWithConstants::SOME_VALUE,
        ];
        $provider[] = [<<<'ANNOTATION'
...
,
        ...
        $provider[] = [<<<'ANNOTATION'
@AnnotationWithConstants({
    EasySwoole\DoctrineAnnotation\Tests\Fixtures\InterfaceWithConstants::SOME_KEY = AnnotationWithConstants::INTEGER
})
ANNOTATION
,
...
@AnnotationWithConstants({
    ...
    EasySwoole\DoctrineAnnotation\Tests\Fixtures\InterfaceWithConstants::SOME_KEY = InterfaceWithConstants::SOME_VALUE
})
ANNOTATION
,
            [
        ...
        $provider[] = [
            '@AnnotationWithConstants(EasySwoole\DoctrineAnnotation\Tests\Fixtures\AnnotationWithConstants::class)',
            AnnotationWithConstants::class,
        ];
        $provider[] = [
            '@EasySwoole\DoctrineAnnotation\Tests\Fixtures\AnnotationWithConstants' .
            '(EasySwoole\DoctrineAnnotation\Tests\Fixtures\AnnotationWithConstants::class)',
            AnnotationWithConstants::class,
        ];
...
DOCBLOCK;
    ...
    public function testAnnotationTargetSyntaxError(): void
    {
        ...
        $docblock = <<<DOCBLOCK
/**
 * @EasySwoole\DoctrineAnnotation\Tests\Fixtures\AnnotationWithTargetSyntaxError()
 */
DOCBLOCK;
...
DOCBLOCK;
    ...
    public function testAnnotationThrowsExceptionWhenAtSignIsNotFollowedByIdentifierInNestedAnnotation(): void
    {
        $parser = new DocParser();
        $this->expectException(AnnotationException::class);
        $parser->parse("@EasySwoole\DoctrineAnnotation\Tests\Name(@')");
    }
    ...
    {
        self::assertFalse(
            class_exists('EasySwoole\DoctrineAnnotation\Tests\Fixture\Annotation\Autoload', false),
            'Pre-condition: EasySwoole\DoctrineAnnotation\Tests\Fixture\Annotation\Autoload not allowed to be loaded.'
        );

        $parser = new DocParser();

        AnnotationRegistry::registerAutoloadNamespace(
            'EasySwoole\DoctrineAnnotation\Tests\Fixtures\Annotation',
            __DIR__ . '/../../../../'
        );
    ...
    public function createTestParser(): DocParser
    {
        ...
        $parser->setImports([
            'name' => Name::class,
            '__NAMESPACE__' => 'EasySwoole\DoctrineAnnotation\Tests',
        ]);
    ...
    public function testSyntaxErrorWithContextDescription(): void
    {
        ...
        $this->expectException(AnnotationException::class);
        $this->expectExceptionMessage(
            "Expected PlainValue, got ''' at position 10 in class \EasySwoole\DoctrineAnnotation\Tests\Name"
        );
        $parser->parse("@Name(foo='bar')", 'class \EasySwoole\DoctrineAnnotation\Tests\Name');
    }
...
DOCBLOCK;
        ...
        //$lexer = new \EasySwoole\DoctrineAnnotation\Lexer();
...
Available properties: data, name'
    ...
    public function testInvalidIdentifierInAnnotation(): void
    {
        $parser = $this->createTestParser();
        $this->expectException(AnnotationException::class);
        $this->expectExceptionMessage('[Syntax Error] Expected EasySwoole\DoctrineAnnotation\DocLexer::T_IDENTIFIER' .
            ' or EasySwoole\DoctrineAnnotation\DocLexer::T_TRUE' .
            ' or EasySwoole\DoctrineAnnotation\DocLexer::T_FALSE' .
            " or EasySwoole\DoctrineAnnotation\DocLexer::T_NULL, got '3.42' at position 5.");
...
DOCBLOCK;
    ...
    {
        $result = $this->createTestParser()->parse('@EasySwoole\DoctrineAnnotation\Tests\Name(foo="""bar""")');
    ...
    public function testMultiByteAnnotation(): void
    {
         ...
         * @EasySwoole\DoctrineAnnotation\Tests\Name
         */
DOCBLOCK;
...
namespace EasySwoole\DoctrineAnnotation\Tests\FooBar;
